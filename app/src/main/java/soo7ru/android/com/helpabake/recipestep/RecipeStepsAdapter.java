...
import static soo7ru.android.com.helpabake.recipestep.RecipeStepDetailFragment.TWO_PANE;
...
public class RecipeStepsAdapter extends RecyclerView.Adapter<RecipeStepsAdapter.MyStepsViewHolder> {
    ...
    @Override
    public void onBindViewHolder(MyStepsViewHolder holder, @SuppressLint("RecyclerView") final int position) {
